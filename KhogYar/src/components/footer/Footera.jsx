      ...
      <div className='footera'>
        ...
        <div className='footeraUpside'>
          <div className='footeraUpsideLeft'>
            <h4 className='footerH4'>KHOGYAR</h4>
            <p className='footerP1'>Premium organic dry fruites from the verdant landscapes of Balochistan, crafted with tradition and care.</p>
          </div>
          ...
          <div className='footerDown'>
            ...
            <p>© 2026 Khogyar All Rights Reserved</p>
            <div>
              <p>Privacy Policy</p>
              <p>Terms</p>
              <p>Refund Policy</p>
